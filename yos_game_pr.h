//======================================================
//    yos_game_pr.h
//    Sample Yoshi Character Display Routine Header
//
//    Copyright (C) 1999-2001 NINTENDO Co.,Ltd.
//======================================================

#ifndef YOS_GAME_PR_H
#define YOS_GAME_PR_H

void p1_yoshiPrint(void);		//Display of Yoshi
void p1_yoshiKagePrint(void);
void p1_eggPrint(void);
void p1_charPrint(void);		//Display of Character
